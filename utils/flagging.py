        ...
        if flag_index is None:
            ...
            for idx, (component, sample) in enumerate(zip(self.components, flag_data)):
                ...
                if utils.is_update(sample):
                    ...
                    # try:
                    #     print('sample: ', processing_utils.decode_base64_to_file(sample))
                    #     decode_sample = processing_utils.decode_base64_to_file(sample)
                    # except:
                    #     pass
                    # print('component: ', component, save_dir, component.deserialize(
                    #         sample,
                    #         save_dir=None,
                    ...
                    csv_data.append(
                        ...
                        # else ""
                        if sample is not None and str(component)!='image'  # not saving gif all the time
                        else component.deserialize(
                            sample,
                            save_dir=None,
                            encryption_key=self.encryption_key,
                        )                    )
